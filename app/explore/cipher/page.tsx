    ...
    <div className="w-full h-screen flex flex-col items-center justify-center bg-amber-950 px-6 gap-5 relative">
      ...
      {step === "note" && (
        <div className="flex flex-col items-center gap-5 w-full max-w-sm">
          ...
          <div className="w-72 bg-stone-800 border border-amber-700 rounded p-3">
      ...
      {step === "input" && (
        <div className="flex flex-col items-center gap-5 w-full max-w-sm">
          <div className="w-72 bg-amber-50 border-4 border-amber-800 rounded p-4 shadow-2xl rotate-1 flex flex-col gap-2">
            <p className="text-center font-bold text-amber-900 text-sm font-title">神秘紙條</p>
          ...
          <div className="flex flex-col items-center gap-3 w-72">
            ...
            <div className="flex gap-2 w-full">
              <input
                ...
                placeholder="例如：ABCD"
                className="flex-1 border-2 border-amber-700 bg-amber-950 text-amber-100 px-3 py-2 text-base uppercase tracking-widest outline-none focus:border-amber-400 font-ui"
                maxLength={10}
              />
              <button
      ...
      {step === "solved" && (
        <div className="flex flex-col items-center gap-3 w-72 text-center">
          ...
          <button
            onClick={() => router.push("/explore")}
            className="mt-2 border-2 border-green-600 px-8 py-2 font-bold font-ui text-green-400 hover:bg-green-700 hover:text-white transition-colors"
          >
            收進背包，返回場景
          </button>
        </div>
